...
export default function Signup() {
  ...
  const [credential, setCredential] = useState({ username: "", name: "", email: "", password: "" });
                  ...
                  <MDBCol md="6" lg="7" className="d-flex align-items-center">
                    <MDBCardBody className="p-4 p-lg-5 text-black">
                      <form onSubmit={handleSubmit}>
                        ...
                        <MDBInput wrapperClass="mb-4" label="Name" id="form2Example27" type="text" size="lg" name='name' value={credential.name} onChange={onchange} />
